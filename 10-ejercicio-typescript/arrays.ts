...
export const jobs: Job[] = [
  {
    ...
    salary: 45000,
    technologies: ['react', 'typescript', 'tailwind'], // tailwind no se encuentra en el type Technology (se ha agregado)
    experienceLevel: 'mid',
    workMode: 'hibrido',
    isActive: true,
...
export const candidates: Candidate[] = [
  {
    ...
    skills: ['react', 'javascript', 'css'], // css no se encuentra en el type Technology (se ha agregado)
    experienceYears: 3,
  },
  {
    id: '2',
